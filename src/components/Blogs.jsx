...
function Blogs() {
  ...
  return (
    <div className="relative flex flex-col md:flex-row w-full h-full">
      <div
        className={`fixed md:static top-0 left-0 h-full md:z-[45] z-[100] bg-black p-4 w-[70%] sm:w-[50%] md:w-[20%] md:border-r-2 md:border-r-sky-300 transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="flex justify-end mb-2 md:hidden">
          <button
            ...
            className="text-2xl text-gray-200 hover:text-red-600 transition"
      ...
      <div className="flex-1 h-full overflow-y-auto bg-black p-4 md:w-[80%]">
        {!selectedBlog ? (
